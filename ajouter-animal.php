...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container { max-width: 800px; margin: 40px auto; padding: 0 2rem; flex: 1; }
        ...
        <form method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" name="nom" required placeholder="Ex: Max, Luna..." autocomplete="off">
                </div>
                <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <label>Race</label>
                    <input type="text" name="race" placeholder="Ex: Berger Allemand" autocomplete="off">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="number" name="age" min="0" step="0.5" placeholder="Ex: 2" autocomplete="off">
                </div>
                <div class="form-group">
                    <label>Poids (kg)</label>
                    <input type="number" name="poids" min="0" step="0.1" placeholder="Ex: 12.5" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <!-- BUG FIX 3: Added autocomplete="off" to prevent auto-fill -->
                <textarea name="description" rows="4" placeholder="Décrivez l'animal : caractère, habitudes, histoire..." autocomplete="off"></textarea>
            </div>
