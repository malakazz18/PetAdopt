...
<div class="container">
    ...
    <div class="pet-container">
        ...
        <div class="info-section">
            ...
            <?php
            $hasCarac = $animal['sterilise'] || $animal['vaccine'] || $animal['errant'] || $animal['vet_status'] === 'VALIDE';
            if ($hasCarac): ?>
                <div class="section">
                    <h3 class="section-title">Caractéristiques</h3>
                    <p class="section-content">
                        <?php if ($animal['sterilise']): ?>✅ Stérilisé<br><?php endif; ?>
                        <?php if ($animal['vaccine']): ?>✅ Vacciné à jour<br><?php endif; ?>
                        <?php if ($animal['errant']): ?>🐾 Animal errant<br><?php endif; ?>
