        ...
        <div class="info-section">
            ...
            <div class="badges">
                ...
                <?php if ($animal['vet_status'] === 'VALIDE'): ?>
                    <span class="badge badge-vet">⭐ Vétérinaire</span>
                <?php endif; ?>
                ...
                <div class="section">
                    ...
                    <div class="health-details <?php echo strtolower($healthUpper); ?>">
                        <?php if (!empty($animal['description_maladie'])): ?>
                            <p><?php echo nl2br(e($animal['description_maladie'])); ?></p>
                        <?php endif; ?>
            ...
            <div class="section">
                ...
                <p class="section-content"><?php echo nl2br(e($animal['description'])); ?></p>
            </div>

            <?php if ($animal['sterilise'] || $animal['vet_status'] === 'VALIDE'): ?>
                <div class="section">
                    <h3 class="section-title">Caractéristiques</h3>
                    <p class="section-content">
                        <?php if ($animal['sterilise']): ?>✅ Stérilisé<br><?php endif; ?>
                        <?php if ($animal['vet_status'] === 'VALIDE'): ?>⭐ Suivi vétérinaire assuré<?php endif; ?>
                    </p>
                </div>
            <?php endif; ?>
            ...
            <div class="owner-card">
                <div class="owner-avatar">
                    <?php if ($animal['vet_status'] === 'VALIDE' && !empty($animal['vet_photo'])): ?>
                ...
                <div class="owner-info">
                    <h4><?php echo e($animal['prenom'] . ' ' . $animal['nom_user']); ?> <?php if ($animal['vet_status'] === 'VALIDE') echo '⭐'; ?></h4>
                    <p><?php echo $animal['vet_status'] === 'VALIDE' ? 'Vétérinaire agréé' : 'Propriétaire'; ?></p>
                    <?php if ($animal['vet_status'] === 'VALIDE' && $animal['nom_cabinet']): ?>
                        <p style="font-size: 0.85rem;">🏥 <?php echo e($animal['nom_cabinet']); ?></p>
                    <?php endif; ?>
