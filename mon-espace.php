...
<body>
    ...
    <div class="container">
        ...
        <div id="mes-animaux" class="tab-content active">
            <h2 class="section-title">Mes animaux en adoption</h2>
            
            <?php if (empty($myAnimals)): ?>
            <div class="empty-state">
                <div style="font-size: 3rem; margin-bottom: 1rem;">🐾</div>
                <p>Vous n'avez pas encore d'animaux en adoption</p>
                <a href="ajouter-animal.php" class="btn btn-primary" style="margin-top: 1rem;">Ajouter un animal</a>
            </div>
            <?php else: ?>
            <div class="card-grid">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div style="margin: 1rem 0;">
                            ...
                            <?php elseif ($req['statut'] === 'ACCEPTEE'): ?>
                            <span class="request-status status-ACCEPTEE">✅ Acceptée ! Contactez le propriétaire</span>
                            <?php else: ?>
                            <span class="request-status status-REFUSEE">❌ Refusée</span>
                            <?php endif; ?>
                        </div>
