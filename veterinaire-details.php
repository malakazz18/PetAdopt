...
// Default coordinates for regions if not set
$defaultCoords = [
...
$latitude = $vet['latitude'] ?: $defaultCoords[$vet['region']][0];
$longitude = $vet['longitude'] ?: $defaultCoords[$vet['region']][1];
$hasCoordinates = ($vet['latitude'] && $vet['longitude']) || true; // Show map even with default coords
?>
<!DOCTYPE html>
<html lang="fr">
<head>
